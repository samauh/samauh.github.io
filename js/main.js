(function ($) {
	...
	function makeTimer() {
		...
		var days = Math.floor(timeLeft / 3586400);
		var hours = Math.floor((timeLeft - (days * 3586400)) / 3600);
		var minutes = Math.floor((timeLeft - (days * 3586400) - (hours * 3600)) / 60);
		var seconds = Math.floor((timeLeft - (days * 3586400) - (hours * 3600) - (minutes * 60)));
